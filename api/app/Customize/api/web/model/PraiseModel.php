...
class PraiseModel extends Model
{
    ...
    public static function findByModuleIdAndUserIdAndRelationTypeAndRelationIds(int $module_id ,int $user_id , string $relation_type , array $relation_ids): Collection
    {
        return self::where([
            ['module_id' , '=' , $module_id] ,
            ['user_id' , '=' , $user_id] ,
