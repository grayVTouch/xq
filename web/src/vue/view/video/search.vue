    ...
    <div class="view">
        ...
        <div class="content">
                    ...
                    <div class="filter-selector horizontal" ref="filter-selector-in-horizontal">
                        ...
                        <div class="action item order" ref="order" @click="showOrderSelectorInHorizontal" v-ripple>
                            <div class="inner">
                                ...
                                <span class="number" v-if="videos.order">1</span>
                            </div>
                            <div class="order-selector hide" ref="order-selector-in-horizontal" @click.stop @mousedown.stop>
                                ...
                                <div class="list">
                                    <div class="item" v-ripple v-for="v in orders" :key="v.key" :data-id="v.key" :class="{cur: videos.order === v.key}" @click.stop="orderInImageProject(v)">{{ v.name }}</div>
            ...
            <div class="data">
                ...
                <div class="empty" v-if="!val.pending.getData && videos.data.length === 0">
            ...
            <div class="pager">
                <my-page
                        ...
                        :show-sizes="false"
                        :page="videos.page"
                        @on-page-change="pageEventInVideo"
                        @on-size-change="sizeEventInVideo"
                ></my-page>
            </div>
            ...
            <div class="filter-selector vertical">
                ...
                <div class="action item order" @click.stop="showOrderSelectorInVertical" v-ripple>
                    ...
                    <div class="order-selector hide" ref="order-selector-in-vertical" @click.stop @mousedown.stop>
                        <div class="list">
                            <div class="item" v-ripple v-for="v in orders" :key="v.key" :data-id="v.key" :class="{cur: videos.order === v.key}" @click="orderInImageProject(v)">{{ v.name }}</div>
                        </div>
                    </div>
                </div>
